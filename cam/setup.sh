...
cp scripts/health_endpoint.py ~/health_endpoint.py

# Install systemd services
echo "Installing systemd services..."
sudo cp systemd/camera_stream.service /etc/systemd/system/
sudo cp systemd/health_endpoint.service /etc/systemd/system/

# Enable and start services
echo "Starting services..."
sudo systemctl daemon-reload
sudo systemctl enable camera_stream.service health_endpoint.service
